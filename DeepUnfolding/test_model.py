...
X_U = [
    [
        scale_factor_X
        * np.matrix(
            np.random.randn(Nr, Nr) + np.random.randn(Nr, Nr) * 1j, dtype=np.complex
        )
        for i in range(User)
    ]
...
X_W = [
    [
        scale_factor_X
        * np.matrix(
            np.random.randn(d, d) + np.random.randn(d, d) * 1j, dtype=np.complex
        )
        for i in range(User)
    ]
    for j in range(Layer)
...
X_V = [
    [
        scale_factor_X
        * np.matrix(
            np.random.randn(Nt, Nt) + np.random.randn(Nt, Nt) * 1j, dtype=np.complex
        )
        for i in range(User)
    ]
    for j in range(Layer)
...
O_U = [
    [
        scale_factor_O
        * np.matrix(
            np.random.randn(Nr, d) + np.random.randn(Nr, d) * 1j, dtype=np.complex
        )
        for i in range(User)
    ]
    for j in range(Layer)
...
O_V = [
    [
        scale_factor_O
        * np.matrix(
            np.random.randn(Nt, d) + np.random.randn(Nt, d) * 1j, dtype=np.complex
        )
        for i in range(User)
    ]
    for j in range(Layer)
